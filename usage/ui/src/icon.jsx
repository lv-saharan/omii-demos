              ...
              ...TYPES.map((type, index) => {
                return {
                  ...
                  pane: ({ update, vnode, component }) => {
                          ...
                          <ul class={classNames("icons", type)}>
                            {Object.keys(icons)
                              ...
                              .map((key) => {
                                return (
                                  <li
                                    title={`<oi-icon name="${key}" type="${type}"/>`}
                                  >
                                    <svg
                    ...
                    return vnode.__pane ?? <oi-loading />;
                  },
                };
              }),

              {
                ...
                pane: (
                  <div>
                    ...
                    <h3>屬性設置</h3>
                    <oi-icon name="1k" size="2" color="red"></oi-icon>

                    <p>頁簽中覆蓋了email樣式</p>
                    <oi-icon name="email" size="2" color="red"></oi-icon>

                    <oi-icon name="email" id="email4" size="4"></oi-icon>

                    <oi-icon name="email" size=".5"></oi-icon>
                    <hr />
                    <button>
                      <oi-icon name="star" type="sharp" />
                      按钮
                    </button>
                    <hr />
                    <h3>直接使用SVG</h3>
